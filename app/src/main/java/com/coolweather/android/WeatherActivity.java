...
public class WeatherActivity extends AppCompatActivity {
    ...
    private LinearLayout forecastLayout; //显示未来几天天气信息布局
    private TextView aqiText; //AQI指数（空气质量）
    ...
    private ImageView bingPicImg; //城市背景图
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" +
                weatherId + "&key=1744385144a34df493d1d123ee97d688";
